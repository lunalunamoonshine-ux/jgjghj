      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl w-full max-w-lg p-6">
        ...
        <div className="flex gap-2 mt-4">
          ...
          <button data-testid="pay-confirm" onClick={submit}
            disabled={(mode === "split" && splitDiff < -0.01) || (mode === "single" && method === "card_terminal" && !terminalOk)}
...
// ---- Single mode ----
function SingleMode({ method, setMethod, amount, setAmount, tip, setTip, total, change, terminalOk, setTerminalOk }) {
  return (
    <>
